...
class Inflector {
     ...
     */
    String lowerCamelCase(String lowerCaseAndUnderscoredWord,
                          char ... delimiterChars) {
     ...
     */
    String upperCamelCase(String lowerCaseAndUnderscoredWord,
                          char ... delimiterChars) {
